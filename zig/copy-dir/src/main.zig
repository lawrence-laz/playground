...
fn copyDirAbsolute(source_path: []const u8, target_path: []const u8) !void {
...
fn copyDir(source_dir: std.fs.Dir, target_dir: std.fs.Dir) !void {
...
pub fn main() !void {
    try copyDirAbsolute(
        "/Users/llaz/git/playground/zig/copy-dir/source/",
        "/Users/llaz/git/playground/zig/copy-dir/target/",
    );
}
